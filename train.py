...
for dataset_config, model_config in experiments:
    ...
    sample_to_token_data_train = train_util.get_train_token_data_dict(dataset_config)
    sample_to_token_data_valid = train_util.get_valid_token_data_dict(dataset_config)
