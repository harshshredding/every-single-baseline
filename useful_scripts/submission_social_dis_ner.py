...
predictions_tsv_file = '/Users/harshverma/every-single-baseline/useful_scripts/external_per_sample/experiment_social_dis_ner_per_sample_external_chatgpt_social_dis_ner_per_sample_chatgpt_model_seq_large_external_pos_test_epoch_19_predictions.tsv'
output_file = './useful_scripts/seq_per_sample_external_pos.tsv'
