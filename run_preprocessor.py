...
from all_preprocessor_configs import config_socialdisner_umls_lowered_exact_word_boundaries

preprocessor_config = config_socialdisner_umls_lowered_exact_word_boundaries()
preprocess(
