...
def read_multiconer_predictions() -> dict[str, List[Anno]]:
    predictions_file_path = "submission/custom_tokenization_batched/experiment_multiconer_custom_tokens_batched_multiconer_fine_tokens_seq_base_custom_tokenization_test_epoch_7_predictions.tsv"
